const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/layout-segment-context-Dhphv7eX.js",
      "assets/rolldown-runtime-S-ySWqyJ.js",
      "assets/framework-XU8gKkFC.js",
      "assets/Icon-Du9TqpuN.js",
    ]),
) => i.map((i) => d[i]);
import { n as e, r as t, t as n } from "./rolldown-runtime-S-ySWqyJ.js";
import { i as r, n as i, r as a, t as o } from "./framework-XU8gKkFC.js";
...
function O(e) {
  ...
  if (t) {
    (e.version !== void 0 && (t.version = e.version),
      ...
      e.__internal_src_page !== void 0 &&
        (t.__internal_src_page = e.__internal_src_page));
    return;
  }
  window.next = { version: e.version ?? te, ...e };
}
var k = null;
function A(e) {
...
function ie(e) {
  return (
    e.schemaVersion === 1 &&
    e.appElementsSchemaVersion === 1 &&
    e.rscPayloadSchemaVersion === 1
  );
}
function P(e) {
  return !re(e) ||
...
var F = t(r(), 1),
  ...
  z = `__route`,
  se = `__rootLayout`,
  ce = `__VINEXT_UNMATCHED_SLOT__`,
  B = Symbol.for(`vinext.unmatchedSlot`);
function le(e, t) {
...
function be(e) {
  return {
    ...
    [L]: [...(e.layoutIds ?? [])],
    [se]: e.rootLayoutTreePath,
  };
}
function xe(e) {
  let t = !1;
  for (let [n, r] of Object.entries(e))
    if (ye(n) && r === `__VINEXT_UNMATCHED_SLOT__`) {
      t = !0;
      break;
    }
  if (!t) return e;
  ...
  for (let [t, r] of Object.entries(e))
    n[t] = ye(t) && r === `__VINEXT_UNMATCHED_SLOT__` ? B : r;
  return n;
}
function Se(e) {
...
function we(e) {
  ...
  for (let n of e) {
    ...
    if (ve(n)?.kind !== `layout`)
      throw Error(
        `[vinext] Invalid __layoutIds in App Router payload: expected layout ids`,
      );
    t.push(n);
  }
  return t;
...
function Oe(e) {
  let t = e[z];
  if (typeof t != `string`)
    throw Error(`[vinext] Missing __route string in App Router payload`);
  let n = e[oe];
  if (n != null && typeof n != `string`)
    throw Error(`[vinext] Invalid __interceptionContext in App Router payload`);
  let r = e[se];
  if (r === void 0)
    throw Error(`[vinext] Missing __rootLayout key in App Router payload`);
...
var H = {
  ...
  unmatchedSlotValue: ce,
  createMetadataEntries: be,
  decode: xe,
  encodeCacheKey: he,
  encodeLayoutId: fe,
  encodeOutgoingPayload: V,
  encodePageId: de,
  encodeRouteId: ue,
  encodeSlotId: me,
  encodeTemplateId: pe,
...
function Ae(e) {
  return Object.keys(e)
    .filter((t) => {
      let n = e[t];
      return H.isSlotId(t) && n != null && n !== B;
    })
    .sort();
}
function je(e) {
...
function Be(e, t = {}) {
  let n = [
    ...
    e.get(l),
    e.get(c),
    ...(t.includeRenderModeHeader === !1 ? [] : [ze(e.get(u))]),
  ];
  return n.every((e) => e === null) ? null : n.map(Re).join(`,`);
}
async function Ve(e) {
  let t = await globalThis.crypto.subtle.digest(`SHA-256`, Ie.encode(e));
  return Le(new Uint8Array(t).subarray(0, Fe));
}
function He(e) {
  return (e.search.startsWith(`?`) ? e.search.slice(1) : e.search)
    .split(`&`)
    .filter((e) => e.length > 0 && !Ue(e));
}
function Ue(e) {
  let t = e.indexOf(`=`),
    n = t === -1 ? e : e.slice(0, t);
  try {
    return decodeURIComponent(n.replaceAll(`+`, ` `)) === Ne;
  } catch {
    return n === Ne;
  }
}
...
function Ge(e, t) {
  let n = He(e);
  (n.push(t.length > 0 ? `${Ne}=${t}` : Ne), (e.search = `?${n.join(`&`)}`));
}
function Ke(e) {
  let t = He(e);
...
async function Xe(e, t) {
  let n = new URL(Ye(e), `http://vinext.local`);
  return (Ge(n, await We(t)), `${n.pathname}${n.search}`);
}
function Ze(e, t) {
  return t ? e === t || e.startsWith(t + `/`) : !1;
}
function U(e, t) {
  return Ze(e, t) ? e.slice(t.length) || `/` : e;
}
function Qe(e) {
...
function $e(e, t) {
  ...
  try {
    ...
    return Ze(e.pathname, t) ? U(e.pathname, t) + e.search + e.hash : null;
  } catch {
    return n;
  }
}
...
function tt(e, t, n = ``) {
  ...
  try {
    let t = new URL(e, r);
    return (
      (n && t.pathname === n ? `` : n ? U(t.pathname, n) : t.pathname) +
      t.search +
      t.hash
    );
  } catch {
...
var it = class extends Error {
  ...
  at = class extends URLSearchParams {
    append(e, t) {
      throw new it();
    }
    delete(e, t) {
  ...
  ot = Symbol.for(`vinext.layoutSegmentContext`),
  st = Symbol.for(`vinext.serverInsertedHTMLContext`);
function ct() {
  if (typeof F.createContext != `function`) return null;
  let e = globalThis;
  return (e[st] || (e[st] = F.createContext(null)), e[st] ?? null);
}
ct();
function lt() {
  if (typeof F.createContext != `function`) return null;
  let e = globalThis;
  return (e[ot] || (e[ot] = F.createContext({ children: [] })), e[ot] ?? null);
}
var ut = Symbol.for(`vinext.navigation.globalAccessors`),
  dt = Symbol.for(`vinext.navigation.clientHydrationContext`);
function ft() {
  return globalThis[ut];
}
function pt() {
  let e = globalThis;
  if (Object.prototype.hasOwnProperty.call(e, dt)) return e[dt] ?? null;
}
function mt(e) {
  globalThis[dt] = e;
}
var ht = null,
  gt = () => {
    ...
    let e = ft();
    return e ? e.getServerContext() : ht;
  },
  _t = (e) => {
    if (typeof window < `u`) {
      ((ht = e), mt(e));
...
function yt() {
  return W ? null : U(window.location.pathname, ``);
}
function bt() {
...
function Tt(e, t = !0) {
  ...
  return (
    e.mountedSlotsHeader != null && n.set(c, e.mountedSlotsHeader),
    e.paramsHeader != null && n.set(s, e.paramsHeader),
    new Response(t ? e.buffer.slice(0) : e.buffer, { status: 200, headers: n })
  );
}
function Et(e, t, n = null, r = null) {
  let i = H.encodeCacheKey(e, n),
    a = xt(),
    o = St(),
    s = { outcome: `pending`, timestamp: Date.now() };
  ((s.pending = t
    .then(async (e) => {
      e.ok
        ? (s.snapshot = { ...(await wt(e)), mountedSlotsHeader: r })
...
function Dt(e, t = null, n = null) {
  let r = H.encodeCacheKey(e, t),
    i = xt(),
    a = i.get(r);
  return !a || a.pending || a.outcome !== `cache-seeded`
    ...
    : (i.delete(r),
      St().delete(r),
      a.snapshot
        ? (a.snapshot.mountedSlotsHeader ?? null) !== n ||
          Date.now() - a.timestamp >= 3e4
          ? null
          : a.snapshot
        : null);
}
var Ot = Symbol.for(`vinext.clientNavigationState`),
  kt = Symbol.for(`vinext.mountedSlotsHeader`);
function At(e) {
  if (W) return;
  let t = window;
  t[kt] = e;
...
function G() {
  ...
  return (
    (e[Ot] ??= {
      ...
      cachedReadonlySearchParams: new at(window.location.search),
      cachedPathname: U(window.location.pathname, ``),
      clientParams: {},
      clientParamsJson: `{}`,
...
function Nt() {
  return G()?.cachedPathname ?? `/`;
}
function Pt() {
  let e = G();
  if (!e) return !1;
  let t = !1,
    n = U(window.location.pathname, ``);
  n !== e.cachedPathname && ((e.cachedPathname = n), (t = !0));
  let r = window.location.search;
  return (
    r !== e.cachedSearch &&
      ((e.cachedSearch = r),
      (e.cachedReadonlySearchParams = new at(r)),
      (t = !0)),
    t
  );
}
...
var It = Symbol.for(`vinext.clientNavigationRenderContext`);
function Lt() {
  if (typeof F.createContext != `function`) return null;
  let e = globalThis;
  return (e[It] || (e[It] = F.createContext(null)), e[It] ?? null);
}
function Rt() {
  let e = Lt();
...
function zt(e, t) {
  let n = typeof window < `u` ? window.location.origin : `http://localhost`,
    r = new URL(e, n);
  return {
    pathname: U(r.pathname, ``),
    searchParams: new at(r.search),
    params: t,
  };
}
var Bt = `{}`;
...
function Ut(e, t) {
  let n = G();
  n && ((n.pendingPathname = U(e, ``)), (n.pendingPathnameNavId = t));
}
function Wt(e) {
  let t = G();
  t &&
...
function Kt() {
  if (W) return gt()?.pathname ?? `/`;
  let e = Rt(),
    t = F.useSyncExternalStore(Gt, Nt, () => gt()?.pathname ?? `/`);
  return e && (G()?.navigationSnapshotActiveCount ?? 0) > 0 ? e.pathname : t;
}
function qt(e) {
...
function Yt(e) {
  ...
  n && n.scrollIntoView({ behavior: `auto` });
}
function Xt(e) {
  let t = G();
  if (!t) return e();
...
function K(e, t) {
  ...
  (n.pendingClientParams !== null &&
    ...
    (n.pendingClientParams = null),
    (n.pendingClientParamsJson = null)),
    (n.pendingPathnameNavId === null ||
      (e !== void 0 && n.pendingPathnameNavId === e)) &&
      ((n.pendingPathname = null), (n.pendingPathnameNavId = null)));
  let i = r || n.hasPendingNavigationUpdate;
  ((n.hasPendingNavigationUpdate = !1), i && Mt());
}
function Zt(e, t, n) {
  Xt(() => {
    G()?.originalPushState.call(window.history, e, t, n);
  });
}
function q(e, t, n) {
  Xt(() => {
    G()?.originalReplaceState.call(window.history, e, t, n);
  });
}
function Qt() {
  q(
...
async function en(e, t, n, r = !1) {
  ...
  let a = nt(i, window.location.href, ``);
  if ((M(a, t), t === `push` && Qt(), Jt(a))) {
    let e = a.includes(`#`) ? a.slice(a.indexOf(`#`)) : ``;
    (t === `replace` ? q(null, ``, a) : Zt(null, ``, a), K(), n && Yt(e));
    return;
  }
  let o = a.indexOf(`#`),
    s = o === -1 ? `` : a.slice(o);
  (typeof window.__VINEXT_RSC_NAVIGATE__ == `function`
    ? await window.__VINEXT_RSC_NAVIGATE__(a, 0, `navigate`, t, void 0, r)
    : (t === `replace` ? q(null, ``, a) : Zt(null, ``, a), K()),
    n && (s ? Yt(s) : window.scrollTo(0, 0)));
}
var tn = {
    bfcacheId: `0`,
    push(e, t) {
      ...
      (ee(e),
        !W &&
          (async () => {
            ...
            let n = nt(t, window.location.href, ``),
              r = yt(),
              i = jt(),
              a = Je({ interceptionContext: r });
            i && a.set(c, i);
            let o = await Xe(n, a),
              s = H.encodeCacheKey(o, r),
              l = St();
            l.has(s) ||
              (l.add(s),
              Et(
...
var an = `NEXT_HTTP_ERROR_FALLBACK`,
...
function sn() {
  throw new on(`NEXT_NOT_FOUND`, `${an};404`);
}
if (!W) {
  let e = G();
  e &&
    ...
    window.addEventListener(`popstate`, (e) => {
      typeof window.__VINEXT_RSC_NAVIGATE__ != `function` && (K(), $t(e.state));
    }),
    (window.history.pushState = function (t, n, r) {
      (e.originalPushState.call(window.history, t, n, r),
        e.suppressUrlNotifyCount === 0 && K());
    }),
...
var un = e({
    DevRecoveryBoundary: () => On,
    ErrorBoundary: () => xn,
    ErrorBoundaryInner: () => bn,
    ForbiddenBoundary: () => Tn,
    ForbiddenBoundaryInner: () => wn,
    NotFoundBoundary: () => Cn,
    RedirectBoundary: () => yn,
    RedirectErrorBoundary: () => vn,
    UnauthorizedBoundary: () => Dn,
    UnauthorizedBoundaryInner: () => En,
  }),
  J = a();
function dn(e) {
...
function Y(e) {
  return { previousPathname: e.pathname, previousResetKey: dn(e.resetKey) };
}
function fn(e, t) {
  let n = dn(e.previousResetKey),
    r = dn(t.previousResetKey);
  return n !== null || r !== null
    ? n !== r
    : e.previousPathname !== t.previousPathname;
}
function pn(e) {
  return cn(e)?.startsWith(`NEXT_REDIRECT;`) ?? !1;
}
function mn(e) {
  try {
...
function _n({ redirect: e, redirectType: t }) {
  let n = rn();
  return (
    F.useEffect(() => {
      F.startTransition(() => {
...
var vn = class extends F.Component {
  constructor(e) {
    (super(e), (this.state = { redirect: null, redirectType: null }));
  }
  static getDerivedStateFromError(e) {
    if (pn(e)) {
      if (e.handled) return { redirect: null, redirectType: null };
      let t = hn(e);
      if (t === null) throw e;
      return { redirect: t, redirectType: gn(e) };
    }
    throw e;
  }
  render() {
    ...
    return e !== null && t !== null
      ? (0, J.jsx)(_n, { redirect: e, redirectType: t })
      : this.props.children;
  }
};
function yn({ children: e }) {
  return (0, J.jsx)(vn, { children: e });
}
var bn = class extends F.Component {
  constructor(e) {
    (super(e), (this.state = { error: null, ...Y(e) }));
  }
  static getDerivedStateFromProps(e, t) {
    let n = Y(e);
    return t.error && fn(n, t)
      ? { error: null, ...n }
      : { error: t.error, ...n };
  }
  static getDerivedStateFromError(e) {
...
function xn({ fallback: e, children: t, resetKey: n }) {
  return (0, J.jsx)(bn, {
    pathname: Kt(),
    resetKey: n,
    fallback: e,
...
var Sn = class extends F.Component {
  constructor(e) {
    (super(e), (this.state = { notFound: !1, ...Y(e) }));
  }
  static getDerivedStateFromProps(e, t) {
    let n = Y(e);
    return t.notFound && fn(n, t)
      ? { notFound: !1, ...n }
      : { notFound: t.notFound, ...n };
  }
  static getDerivedStateFromError(e) {
    if (e && typeof e == `object` && `digest` in e) {
      let t = String(e.digest);
      if (t === `NEXT_NOT_FOUND` || t === `NEXT_HTTP_ERROR_FALLBACK;404`)
        return { notFound: !0 };
    }
    throw e;
  }
...
function Cn({ fallback: e, children: t, resetKey: n }) {
  return (0, J.jsx)(Sn, {
    pathname: Kt(),
    resetKey: n,
    fallback: e,
...
var wn = class extends F.Component {
  constructor(e) {
    (super(e), (this.state = { forbidden: !1, ...Y(e) }));
  }
  static getDerivedStateFromProps(e, t) {
    let n = Y(e);
    return t.forbidden && fn(n, t)
      ? { forbidden: !1, ...n }
      : { forbidden: t.forbidden, ...n };
  }
  static getDerivedStateFromError(e) {
    if (
      e &&
...
function Tn({ fallback: e, children: t, resetKey: n }) {
  return (0, J.jsx)(wn, {
    pathname: Kt(),
    resetKey: n,
    fallback: e,
...
var En = class extends F.Component {
  constructor(e) {
    (super(e), (this.state = { unauthorized: !1, ...Y(e) }));
  }
  static getDerivedStateFromProps(e, t) {
    let n = Y(e);
    return t.unauthorized && fn(n, t)
      ? { unauthorized: !1, ...n }
...
function Dn({ fallback: e, children: t, resetKey: n }) {
  return (0, J.jsx)(En, {
    pathname: Kt(),
    resetKey: n,
    fallback: e,
...
var On = class extends F.Component {
    constructor(e) {
  ...
  kn = e({
    ...
    ElementsContext: () => jn,
    ParallelSlot: () => Ln,
    ParallelSlotsContext: () => Nn,
    Slot: () => Fn,
    UNMATCHED_SLOT: () => B,
    mergeElements: () => Pn,
  }),
  An = Object.freeze({}),
  jn = F.createContext(An),
  Mn = F.createContext(null),
...
function Pn(e, t, n = {}) {
  ...
  let s = new Set(
    [...Object.keys(e), ...Object.keys(t)].filter((e) => H.isSlotId(e)),
  );
  for (let n of s) t[n] === B && Object.hasOwn(e, n) && (o[n] = e[n]);
  if (r) for (let e of s) Object.hasOwn(t, e) || delete o[e];
  else if (i) {
    for (let t of s)
      if (!Object.hasOwn(o, t) && Object.hasOwn(e, t)) {
        let n = e[t];
...
function Fn({ id: e, children: t, parallelSlots: n }) {
  let r = F.useContext(jn);
  ...
  return (
    ...
    (0, J.jsx)(Nn.Provider, {
      value: n ?? null,
      children: (0, J.jsx)(Mn.Provider, { value: t ?? null, children: i }),
    })
  );
}
function In() {
  return F.useContext(Mn);
}
function Ln({ name: e }) {
  return F.useContext(Nn)?.[e] ?? null;
}
j(A(e({})));
function Rn(e) {
...
function Z(e, t = {}) {
  return { schemaVersion: 0, entries: [Kn(e, t)] };
}
function qn(e, t, n = {}) {
  return { schemaVersion: e.schemaVersion, entries: [Kn(t, n), ...e.entries] };
}
function Jn(e) {
  return {
    kind: `requestWork`,
    ...
    work: e.work,
    trace: Z(X.requestWork, { eventKind: e.eventKind, targetHref: Yn(e.work) }),
  };
}
function Yn(e) {
  switch (e.kind) {
...
function Qn(e, t) {
  if (Zn(e.rootBoundaryId, t.rootBoundaryId) !== `currentRootBoundary`)
    return [];
  let n = [],
...
function nr(e) {
  let t = Qn(e.currentSnapshot, e.targetSnapshot);
  return e.lane === `traverse` ? t : [...t, ...er(e.currentSnapshot, t)];
}
function rr(e) {
  let t = Xn(e);
  if (e.event.token.lane === `prefetch`)
    return {
      ...
      reason: `prefetchOnly`,
      token: e.event.token,
      trace: Z(X.prefetchOnly, t),
    };
  let n = Zn(
    e.state.visibleSnapshot.rootBoundaryId,
    e.event.result.targetSnapshot.rootBoundaryId,
  );
  return n === `rootBoundaryChanged`
    ? {
        ...
        token: e.event.token,
        trace: Z(X.rootBoundaryChanged, t),
    ...
    : n === `rootBoundaryUnknownFallback`
      ? {
          ...
          token: e.event.token,
          trace: Z(X.rootBoundaryUnknown, t),
        }
      : {
          kind: `proposeCommit`,
          proposal: {
            preserveAbsentSlots: !1,
            preserveElementIds: nr({
...
function ir(e) {
  switch (e.event.kind) {
    ...
    case `flightResponseArrived`:
      return rr({ event: e.event, state: e.state });
    default: {
      let t = e.event;
...
var ar = {
    classifyRootBoundaryTransition: Zn,
    plan: ir,
    resolveCurrentRootBoundaryElementPersistence: tr,
    resolveMountedParallelSlotPersistence: $n,
    resolveSameLayoutAncestorPersistence: Qn,
  },
  or = `__vinext_previousNextUrl`;
function sr(e) {
...
function dr(e, t = ``) {
  return e === null ? null : U(new URL(e, `http://localhost`).pathname, t);
}
function fr(e) {
  let t = Je();
  t.set(d, e.actionId);
  let n = dr(e.previousNextUrl, e.basePath);
  n !== null && t.set(l, n);
  let r = je(e.elements);
  return (r !== null && t.set(c, r), { headers: t });
}
function pr(e) {
  let t = mr(e);
...
function gr(e) {
  let t = [];
  for (let n of Ae(e)) {
    let e = H.parseElementKey(n);
    e?.kind === `slot` &&
      t.push({ ownerLayoutId: H.encodeLayoutId(e.treePath), slotId: n });
  }
  return t;
}
function _r(e) {
  return {
    displayUrl: hr(e.navigationSnapshot),
    layoutIds: e.layoutIds,
    matchedUrl: e.navigationSnapshot.pathname,
    mountedParallelSlots: gr(e.elements),
...
function vr(e) {
  return {
    displayUrl: hr(e.action.navigationSnapshot),
    layoutIds: e.action.layoutIds,
    matchedUrl: e.action.navigationSnapshot.pathname,
    mountedParallelSlots: gr(e.action.elements),
    rootBoundaryId: e.rootLayoutTreePath,
    routeId: e.routeId,
  };
}
...
function xr(e) {
  let t = vr(e.pending),
    n = yr({ pending: e.pending, targetSnapshot: t });
  return ar.plan({
    routeManifest: null,
    state: {
      ...
      visibleSnapshot: _r(e.currentState),
    },
    event: {
...
async function Cr(e) {
  let t = await e.nextElements,
    n = H.readMetadata(t),
    r =
      e.previousNextUrl === void 0
        ? e.currentState.previousNextUrl
        : e.previousNextUrl;
  return {
    action: {
      elements: t,
...
var wr = Symbol(`ApprovedVisibleCommit`);
function Tr(e, t) {
  return (Er(t), kr(e, t));
}
function Er(e) {
...
function Or(e, t, n) {
  ...
  return { ...t, activeOperation: Dr(n, r), visibleCommitVersion: r };
}
function kr(e, t) {
  let { action: n } = t;
  switch (n.type) {
    ...
    case `navigate`:
      return Or(
        e,
        {
          elements: Pn(e.elements, n.elements, {
...
function Ar(e) {
  ...
  switch (t.disposition) {
    ...
    case `dispatch`:
      return jr(t.trace, t.preserveElementIds, t.preserveAbsentSlots);
    default:
      throw Error(
        `[vinext] Unknown navigation commit disposition: ` + String(t),
      );
  }
}
function jr(e = Z(X.commitCurrent), t = [], n = !1) {
  return {
    disposition: `commit`,
...
function Ir(e, t) {
  switch (e.disposition) {
    case `commit`:
      return { ...e, trace: Fr(e.trace, Wn.visibleCommit, t) };
    case `hard-navigate`:
      return { ...e, trace: Fr(e.trace, Wn.hardNavigate, t) };
    case `no-commit`:
      return { ...e, trace: Fr(e.trace, Wn.noCommit, t) };
    default:
...
function Lr(e) {
  ...
  if (t.disposition !== `commit`)
    throw Error(
      `[vinext] HMR visible commit approval did not produce a commit decision`,
    );
  return Nr({ decision: t, pending: e });
}
function Rr(e) {
  let t = Ir(
    Ar({
  ...
  switch (t.disposition) {
    case `commit`:
      return {
        approvedCommit: Nr({ decision: t, pending: e.pending }),
        decision: t,
      };
    case `hard-navigate`:
    case `no-commit`:
...
var Br = `__vinext_hard_navigation_target__`;
function Vr(e) {
  try {
...
function Hr() {
  try {
    return window.sessionStorage.getItem(Br);
  } catch {
    return null;
  }
}
function Ur(e) {
  try {
    return (
      window.sessionStorage.setItem(Br, e),
      window.sessionStorage.getItem(Br) === e
    );
  } catch {
    return !1;
  }
...
function Wr() {
  try {
    window.sessionStorage.removeItem(Br);
  } catch {}
}
function Gr(e, t = `assign`) {
  let n = Vr(e),
    r = Vr(window.location.href);
  return Hr() === n && r === n
    ? (Wr(),
      console.error(
...
function Kr(e = {}) {
  let t = e.commitClientNavigationState ?? K,
    n = e.performHardNavigation ?? Gr,
    r = 0,
    i = 0,
    a = new Map(),
    o = new Map(),
  ...
  function p() {
    if (!s)
      throw Error(`[vinext] Browser router state setter is not initialized`);
    return s;
  }
  function m() {
  ...
  function S(e) {
    !e ||
      e.settled ||
      ((e.settled = !0), e.resolve(m()), l === e && (l = null));
  }
  function C(e, t) {
    (S(t), b(e) && Wt(e));
  }
  function ee(e, t) {
    !e ||
      e.settled ||
      ((e.settled = !0), e.resolve(Tr(m(), t)), l === e && (l = null));
  }
  function w(e, t) {
    t && o.set(e, t);
  }
  function T(e) {
    for (let [n, r] of o)
      n > e ||
        (o.delete(n), n === e ? r() : t(void 0, { releaseSnapshot: !0 }));
  }
  function E(e) {
  ...
  function te({ renderId: e, children: t }) {
    return (
      (0, F.useLayoutEffect)(() => {
        T(e);
  ...
  async function A(e) {
    ...
    try {
      ...
      if (o.decision.disposition === `no-commit`)
        return (S(e.pendingRouterState), a.delete(r), s?.(), `no-commit`);
      if (o.decision.disposition === `hard-navigate`)
        return (
          S(e.pendingRouterState),
          a.delete(r),
          n(e.targetHref) ? `hard-navigate` : `no-commit`
        );
      let c = o.approvedCommit;
      if (c === null)
        throw Error(
          `[vinext] Commit decision did not approve a visible commit`,
        );
      (w(
        r,
...
var qr = `__VINEXT_RSC_FORM_STATE__`;
function Jr(e) {
  let t = e.__VINEXT_RSC_FORM_STATE__ ?? null;
  return (delete e[qr], t);
}
function Yr(e) {
...
var Zr = o(),
  Qr = `https://nextjs.org/docs/messages/failed-to-find-server-action`;
function $r(e) {
...
function oi(e) {
  if (ai) return;
  ai = !0;
  let t = ni((t) => e.load(ri(t)));
  ((globalThis.__vite_rsc_client_require__ = t), ii());
}
var si = n((e) => {
    var t = i(),
      n = { stream: !0 },
    ...
    function w(e, t, n, r, i) {
        ...
        if (typeof o == `object`) {
          ...
          if (s !== void 0)
            ...
            e.indexOf(`:`) === -1 &&
              ((s = _.get(this)),
              s !== void 0 &&
                ((e = s + `:` + e), _.set(o, e), n !== void 0 && n.set(e, o)));
          if (b(o)) return o;
      ...
      var f = 1,
        ...
        T = d(e, 0);
      return (
        m === null ? r(T) : (m.set(t + `0`, T), p === 0 && r(m)),
        function () {
    ...
    function T(e, t, n) {
      C.has(e) || C.set(e, { id: t, originalBind: e.bind, bound: n });
    }
    function E(e, t) {
      function n() {
            ...
            if (typeof i != `function`) {
              ...
              if (a !== null)
                switch (
                  ...
                  r--,
                  n !== null &&
                    ((i = n.indexOf(i)), i !== -1 && n.splice(i, 1)),
                  e.status)
                ) {
                  case `fulfilled`:
                    O(t, e.value, e);
    ...
    function re(e, t, n, r) {
      N(
        e,
        t,
        (r ? `{"done":true,"value":` : `{"done":false,"value":`) + n + `}`,
      );
    }
    function N(e, t, n) {
    ...
    function oe(e) {
      return { $$typeof: g, _payload: e, _init: te };
    }
    function L(e, t) {
      var n = e._chunks,
        r = n.get(t);
      return (
        r ||
          ((r = e._closed
            ? new D(`rejected`, null, e._closedReason)
    ...
    function B(e, t, n, r, i) {
      ...
      switch (a.status) {
          ...
          for (var o = 1; o < t.length; o++) {
            for (; typeof a == `object` && a && a.$$typeof === g;) {
              ...
              switch (a.status) {
                ...
                case `blocked`:
                case `pending`:
                  return se(a, n, r, e, i, t.slice(o - 1));
                case `halted`:
                  return (
                    P
                      ? ((e = P), e.deps++)
        ...
        default:
          return (
            P
              ? ((P.errored = !0), (P.value = null), (P.reason = a.reason))
              : (P = {
                  parent: null,
                  chunk: null,
                  value: null,
    ...
    function he(e, t, n, r) {
      if (r[0] === `$`) {
        ...
        switch (r[1]) {
          ...
          case `K`:
            return ((r = r.slice(2)), B(e, r, t, n, fe));
          case `Z`:
            return Te();
          case `i`:
            return ((r = r.slice(2)), B(e, r, t, n, pe));
          case `I`:
            return 1 / 0;
          case `-`:
            return r === `$-0` ? -0 : -1 / 0;
          ...
          default:
            return ((r = r.slice(1)), B(e, r, t, n, me));
        }
      }
      return r;
    }
    ...
    function _e(e, t, n, r, i, a, o) {
      ...
      ((this._bundlerConfig = e),
        ...
        (this._callServer = r === void 0 ? ge : r),
    ...
    function ve(e, t, n) {
      ...
      r && r.status !== `pending`
        ...
        : ((n = new D(`fulfilled`, n, null)), e.set(t, n));
    }
    function ye(e, t, n) {
      var r = e._chunks,
        i = r.get(t);
      ...
      if ((n = u(o))) {
        ...
        i
          ? ie(e, i, o)
          : ((i = new D(`resolved_module`, o, null)), r.set(t, i));
    }
    function be(e, t, n, r) {
      e = e._chunks;
      var i = e.get(t);
      i
        ...
        : ((n = new D(`fulfilled`, n, r)), e.set(t, n));
    }
    function xe(e, t, n) {
      var r = null,
        i = !1;
    ...
    function we(e, t, n) {
      ...
      ((o[y] = function () {
        ...
        return Ce(function (t) {
          ...
          if (e === r.length) {
            if (i) return new D(`fulfilled`, { done: !0, value: void 0 }, null);
        ...
        be(e, t, n ? o[y]() : o, {
          enqueueValue: function (e) {
            if (a === r.length)
              r[a] = new D(`fulfilled`, { done: !1, value: e }, null);
            else {
              var t = r[a],
                n = t.value,
                i = t.reason;
          ...
          close: function (t) {
            if (!i)
              for (
                i = !0,
                  a === r.length ? (r[a] = ne(e, t, !0)) : re(e, r[a], t, !0),
                  a++;
                a < r.length;
              )
                re(e, r[a++], `"$undefined"`, !0);
          },
          error: function (t) {
            if (!i)
              for (
                i = !0, a === r.length && (r[a] = new D(`pending`, null, null));
                a < r.length;
              )
                M(e, r[a++], t);
          },
    ...
    function V(e, t, n, r, i, a) {
      ((n = n.length === 0 && r.byteOffset % a === 0 ? r : Ee(n, r)),
        (i = new i(n.buffer, n.byteOffset, n.byteLength / a)),
        ve(e, t, i));
    }
    function De(e, t, r, i, a, o) {
      switch (i) {
        case 65:
          ve(e, r, Ee(a, o).buffer);
          return;
        case 79:
          V(e, r, a, o, Int8Array, 1);
          return;
        case 111:
          ve(e, r, a.length === 0 ? o : Ee(a, o));
          return;
        case 85:
          V(e, r, a, o, Uint8ClampedArray, 1);
          return;
        case 83:
          V(e, r, a, o, Int16Array, 2);
          return;
        case 115:
          V(e, r, a, o, Uint16Array, 2);
          return;
        case 76:
          V(e, r, a, o, Int32Array, 4);
          return;
        case 108:
          V(e, r, a, o, Uint32Array, 4);
          return;
        case 71:
          V(e, r, a, o, Float32Array, 4);
          return;
        case 103:
          V(e, r, a, o, Float64Array, 8);
          return;
        case 77:
          V(e, r, a, o, BigInt64Array, 8);
          return;
        case 109:
          V(e, r, a, o, BigUint64Array, 8);
          return;
        case 86:
          V(e, r, a, o, DataView, 1);
          return;
      }
      t = e._stringDecoder;
      ...
      switch (((a = s += t.decode(o)), i)) {
        ...
        case 72:
          switch (
            ...
            case `L`:
              ((r = e[0]),
                (i = e[1]),
                e.length === 3 ? a.L(r, i, e[2]) : a.L(r, i));
              break;
            case `m`:
        ...
        case 69:
          ((i = e._chunks),
            ...
            (t = Te()),
            (t.digest = a.digest),
            o ? M(e, o, t) : ((e = new D(`rejected`, null, t)), i.set(r, e)));
          break;
        case 84:
          ((e = e._chunks),
            (i = e.get(r)) && i.status !== `pending`
              ? i.reason.enqueueValue(a)
              : ((a = new D(`fulfilled`, a, null)), e.set(r, a)));
          break;
        case 78:
        case 68:
        case 74:
        ...
        default:
          ((i = e._chunks),
            (o = i.get(r))
              ? N(e, o, a)
              : ((e = new D(`resolved_model`, a, e)), i.set(r, e)));
      }
    }
    function Oe(e) {
      return function (t, n) {
        if (t !== `__proto__`) {
          if (typeof n == `string`) return he(e, this, t, n);
          if (typeof n == `object` && n) {
            if (n[0] === h) {
              if (
                ...
                if (((n = P), (P = n.parent), n.errored))
                  ((t = new D(`rejected`, null, n.reason)), (t = oe(t)));
                else if (0 < n.deps) {
    ...
    function Ae(e, t, n) {
      function r(t) {
        ...
        t = a._rowID;
        for (
          var u = a._rowTag, d = a._rowLength, f = a._buffer, p = s.length;
          c < p;
        ) {
          var m = -1;
          switch (l) {
          ...
          if (-1 < m)
            ...
            ((s = new Uint8Array(s.buffer, h, s.byteLength - c)),
              f.push(s),
              (d -= s.byteLength));
            break;
          }
    ...
    ((e.createFromFetch = function (e, t) {
      ...
      (e.createFromReadableStream = function (e, t) {
        return ((t = ke(t)), Ae(t, e, H.bind(null, t)), L(t, 0));
      }),
...
function li(e, t = {}) {
  return ci.createFromReadableStream(e, {
    callServer: fi,
    findSourceMapURL: hi,
    ...t,
  });
...
function ui(e, t = {}) {
  return ci.createFromFetch(e, { callServer: fi, findSourceMapURL: hi, ...t });
}
var di = ci.encodeReply;
function fi(...e) {
...
var mi = ci.createTemporaryReferenceSet;
function hi(e, t) {
  let n = new URL(`/__vite_rsc_findSourceMapURL`, import.meta.url);
  return (
    n.searchParams.set(`filename`, e),
    n.searchParams.set(`environmentName`, t),
    n.toString()
  );
}
var gi = `modulepreload`,
  _i = function (e) {
    return `/` + e;
  },
  vi = {},
  ...
  bi = {
    "15c18cfaeeff": async () => {
      let e = await yi(
        () => import(`./layout-segment-context-Dhphv7eX.js`),
    ...
    "593f344dc510": async () => {
      let e = await yi(() => Promise.resolve().then(() => un), void 0);
      return {
        get ErrorBoundary() {
    ...
    "8c0f216c4604": async () => {
      let e = await yi(() => Promise.resolve().then(() => kn), void 0);
      return {
        get Children() {
          return e.Children;
        },
...
function Vi(e) {
  ...
  return () => {
    if (!Q.isCurrentNavigation(r)) {
      K(void 0, { releaseSnapshot: !0 });
      return;
    }
    let e = new URL(t, window.location.origin).href;
    Li(i);
    let o = cr(n === `replace` ? window.history.state : null, a);
    (n === `replace` && window.location.href !== e
      ? q(o, ``, t)
      : n === `push` && window.location.href !== e && Zt(o, ``, t),
      (ji = null),
      K(r));
  };
}
...
async function Ui(e, t, n) {
  let r = zt(window.location.href, Ai);
...
function Ki(e, t, n, r) {
  ...
  ($.delete(i), Wi());
  let a = Date.now();
  $.set(i, { params: r, expiresAt: a + Ti, response: n });
}
function qi(e, t) {
  if (t !== void 0)
    return { interceptionContext: dr(t, ``), previousNextUrl: t };
  switch (e) {
    case `navigate`:
      return { interceptionContext: yt(), previousNextUrl: bt() };
    case `traverse`: {
      let e = lr(window.history.state);
      return { interceptionContext: dr(e, ``), previousNextUrl: e };
    }
    case `refresh`: {
...
function Ji(e) {
  return Promise.resolve(e).then((e) => H.decode(e));
}
function Yi({ initialElements: e, initialNavigationSnapshot: t }) {
  let n = (0, F.use)(e),
    r = H.readMetadata(n),
    [i, a] = (0, F.useState)({
  ...
  ((s.current = o),
    ...
    (0, F.useLayoutEffect)(() => {
      At(je(s.current.elements));
    }, [o.elements]),
    (0, F.useLayoutEffect)(() => {
      o.renderId === 0 &&
        q(
          cr(window.history.state, o.previousNextUrl),
          ``,
          window.location.href,
        );
    }, [o.previousNextUrl, o.renderId]));
  let c = (0, F.createElement)(
      yn,
      null,
      (0, F.createElement)(
        Di,
        ...
        (0, F.createElement)(
          jn.Provider,
          { value: o.elements },
          (0, F.createElement)(Fn, { id: o.routeId }),
        ),
      ),
    ),
    l = Lt();
  return l
    ? (0, F.createElement)(l.Provider, { value: o.navigationSnapshot }, c)
    : c;
}
function Xi(e, t, n) {
  vt({ pathname: e, searchParams: new URLSearchParams(t), params: n });
}
function Zi(e) {
  try {
    return decodeURIComponent(e);
...
async function oa() {
  ...
  if (e.__VINEXT_RSC__ || e.__VINEXT_RSC_CHUNKS__ || e.__VINEXT_RSC_DONE__) {
    if ((ia(), Wr(), e.__VINEXT_RSC__)) {
      let t = e.__VINEXT_RSC__;
      delete e.__VINEXT_RSC__;
      let n = t.params ?? {};
      return (
        t.params && Ii(t.params),
        t.nav && Xi(t.nav.pathname, t.nav.searchParams, n),
        Hn(t.rsc)
      );
    }
    let t = e.__VINEXT_RSC_PARAMS__ ?? {};
    return (
      e.__VINEXT_RSC_PARAMS__ && Ii(e.__VINEXT_RSC_PARAMS__),
      e.__VINEXT_RSC_NAV__ &&
        Xi(e.__VINEXT_RSC_NAV__.pathname, e.__VINEXT_RSC_NAV__.searchParams, t),
      Un()
    );
  }
  let t = Je(),
    n = await fetch(
      await Xe(window.location.pathname + window.location.search, t),
      { credentials: `include`, headers: t },
    );
  if (!n.ok) return aa(`returned ${n.status}`);
  let r = n.headers.get(`content-type`) ?? ``;
  if (!r.startsWith(`text/x-component`))
    return aa(`returned non-RSC content-type "${r || `(missing)`}"`);
...
function sa() {
  pi(async (e, t) => {
    let n = mi(),
      r = await di(t, { temporaryReferences: n }),
      i = Mi(),
      { headers: a } = fr({
        actionId: e,
        basePath: ``,
      ...
      o = await fetch(
        await Xe(window.location.pathname + window.location.search, a),
        { method: `POST`, headers: a, body: r },
      );
    if (ei(o)) throw Error($r(e));
    ...
    if (s) {
      ...
      try {
        if (
          new URL(s, window.location.origin).origin !== window.location.origin
        ) {
    ...
    let c = await ui(Promise.resolve(o), { temporaryReferences: n });
    if ((zn(c) && Bi(), Rn(c))) {
      if (c.root !== void 0)
        return Ui(Promise.resolve(H.decode(c.root)), c.returnValue, i);
      if (c.returnValue) {
    ...
    return Ui(Promise.resolve(H.decode(c)), void 0, i);
  });
}
async function ca() {
  sa();
...
function la(e) {
  let t = Ji(li(e)),
    n = zt(window.location.href, Ai);
  q(cr(window.history.state, null), ``, window.location.href);
  let r = Xr(() => ji),
    i = Yr({ formState: Jr(Bn()), onUncaughtError: r });
  ((window.__VINEXT_RSC_ROOT__ = (0, Zr.hydrateRoot)(
    document,
    (0, F.createElement)(Yi, {
      initialElements: t,
    ...
    (window.__VINEXT_CLEAR_NAV_CACHES__ = Bi),
    (window.__VINEXT_RSC_NAVIGATE__ = async function (
      e,
      t = 0,
      n = `navigate`,
      r,
      ...
      try {
        ...
        for (;;) {
          ...
          m && h.set(c, m);
          let g = await Xe(e.pathname + e.search, h),
            _ = Gi(g, r, m, n);
          if (_) {
            if (!Q.isCurrentNavigation(l)) return;
            let e = _.params,
              t = zt(u, e),
              r = Ji(ui(Promise.resolve(Tt(_.response))));
            if (!Q.isCurrentNavigation(l)) return;
          ...
          if (
            ((v ||= await fetch(g, { headers: h, credentials: `include` })),
            !Q.isCurrentNavigation(l))
          )
            return;
          let b = (v.headers.get(`content-type`) ?? ``).startsWith(
            `text/x-component`,
          );
          if (!v.ok || !b || !v.body) {
            let e = y ?? v.url,
          ...
          if (x.pathname !== S.pathname) {
            let e = qe(x.pathname) + x.search;
            (q(cr(null, i), ``, e), (u = e), (d = void 0), (f = i), (p += 1));
            continue;
          }
          ...
          if (!w) return;
          let [E, D] = w.tee(),
            te = new Response(E, { status: v.status, headers: v.headers }),
            O = new Response(D).arrayBuffer();
          if (!Q.isCurrentNavigation(l)) return;
          let k = Ji(ui(Promise.resolve(te)));
          if (
            !Q.isCurrentNavigation(l) ||
            (await Hi(k, ee, u, l, d, C, i, o, Si(n), Ci(n))) !== `committed` ||
            !Q.isCurrentNavigation(l)
          )
            return;
          let A = await k,
        ...
        if (!Q.isCurrentNavigation(l)) return;
        (ea || console.error(`[vinext] RSC navigation error:`, e),
          (window.location.href = u));
      } finally {
    ...
    window.addEventListener(`popstate`, (e) => {
      ...
      let t =
        ...
        Promise.resolve();
      ((window.__VINEXT_RSC_PENDING__ = t),
        t.finally(() => {
          ($i(e.state),
            window.__VINEXT_RSC_PENDING__ === t &&
